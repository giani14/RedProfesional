  ...
  return (
    <View style={styles.mainContainer}>
        ...
        <View style={styles.userCard}>
          <View style={styles.userCardContent}>
            ...
            {avatar_url ? (
              ...
              <View style={[styles.avatar, { backgroundColor: '#1A3B63', justifyContent: 'center', alignItems: 'center' }]}>
                <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 20 }}>
                  {nombre ? (nombre as string).split(' ').map(n => n[0]).join('').toUpperCase().substring(0, 2) : 'U'}
                </Text>
              </View>
            )}
      ...
      <View style={styles.bottomDecorations} pointerEvents="none">
        <View style={[styles.bottomWaveBlue, { position: 'absolute', bottom: -50, left: -50, width: 200, height: 200, borderRadius: 100, backgroundColor: '#A5C4D4', opacity: 0.5 }]} />
        <View style={[styles.bottomWaveYellow, { position: 'absolute', bottom: -100, right: -20, width: 250, height: 250, borderRadius: 125, backgroundColor: '#FDE68A', opacity: 0.5 }]} />
      </View>
    </View>
  );
}
